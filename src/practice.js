...
export class Practice {
  ...
  static getPracticeByCondition(condition) {
    return new Promise(function(resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?query=${condition}&location=or-portland&user_location=45.5122%2C%20122.6587&sort=last-name-asc&fields=practices&skip=0&limit=100&user_key=${process.env.exports.apiKey}`;
